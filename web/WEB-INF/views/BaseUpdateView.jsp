    ...
    <body>
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <c:if test="${descriptionFieldType == 'input'}">                   
                                <input type="text" class="form-control" id="${descriptionFieldId}" name="${descriptionFieldId}" required="${descriptionFieldRequired}" placeholder="${descriptionFieldPlaceHolder}" max="${descriptionFieldMaxSize}" value="${descriptionFieldValue}">  
                            </c:if>                        
                            <c:if test="${descriptionFieldType == 'textArea'}">                      
                                <textarea class="form-control" id="${descriptionFieldId}" name="${descriptionFieldId}" required="${descriptionFieldRequired}" placeholder="${descriptionFieldPlaceHolder}" rows="${descriptionFieldRows}" maxlength="${descriptionFieldMaxSize}">${descriptionFieldValue}</textarea>  
                            </c:if>
        ...
        <script type="text/javascript">
            $(document).ready(function () {
                ...
                $("#${descriptionFieldId}").trigger('keyup');
