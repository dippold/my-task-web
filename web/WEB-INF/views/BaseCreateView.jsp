    ...
    <body>
        ...
        <div id="main" class="container-fluid">
            ...
            <form id="formCreate" name="formCreate" method="POST" action="${urlToGo}">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <c:if test="${nameFieldType == 'input'}">
                            <input type="text" class="form-control" id="${nameFieldId}" name="${nameFieldId}" required="${nameFieldRequired}" placeholder="${nameFieldPlaceHolder}" max="${nameFieldMaxSize}">                       
                        </c:if>                        
                        <c:if test="${nameFieldType == 'textArea'}">
                            <textarea class="form-control" id="${nameFieldId}" name="${nameFieldId}" required="${nameFieldRequired}" placeholder="${nameFieldPlaceHolder}" rows="${nameFieldRows}" maxlength="${nameFieldMaxSize}"></textarea>                        
                        </c:if>
                ...
                <!-- CAMPO DESCRIÇÃO OPCIONAL (LINHA-2) -->
                <c:if test="${showDescriptionField == true}">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <c:if test="${descriptionFieldType == 'input'}">                   
                                <input type="text" class="form-control" id="${descriptionFieldId}" name="${descriptionFieldId}" required="${descriptionFieldRequired}" placeholder="${descriptionFieldPlaceHolder}" max="${descriptionFieldMaxSize}">  
                            </c:if>                        
                            <c:if test="${descriptionFieldType == 'textArea'}">                      
                                <textarea class="form-control" id="${descriptionFieldId}" name="${descriptionFieldId}" required="${descriptionFieldRequired}" placeholder="${descriptionFieldPlaceHolder}" rows="${descriptionFieldRows}" maxlength="${descriptionFieldMaxSize}"></textarea>  
                            </c:if>
                            &nbsp;<span id="descriptionFieldCount" class="badge badge-warning">${descriptionFieldMaxSize} Restantes!</span>
                        </div>

                    </div><!-- /LINHA-2 -->                     

                </c:if> <!-- /CAMPO DESCRIÇÃO OPCIONAL (LINHA-2) -->
        ...
        <script type="text/javascript">
            $(document).ready(function () {
                ...
                $("#${descriptionFieldId}").keyup(
                        function () {
                            var limite = ${descriptionFieldMaxSize};
                            var caracteresDigitados = $(this).val().length;
                            var caracteresRestantes = limite - caracteresDigitados;
                            $("#descriptionFieldCount").text(caracteresRestantes + " Restantes!");
                        }
                );
