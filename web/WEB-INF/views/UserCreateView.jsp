            ...
            <form id="formCreate" name="formCreate" method="POST" action="${urlToGo}">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="email" id="${emailFieldId}" name="${emailFieldId}" class="form-control"  required="${emailFieldRequired}" placeholder="${emailFieldPlaceHolder}" max="${emailFieldMaxSize}">
